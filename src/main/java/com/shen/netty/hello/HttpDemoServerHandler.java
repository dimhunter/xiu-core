...
public class HttpDemoServerHandler extends
...
////						HttpHeaders.Values.KEEP_ALIVE, true);
		...
		boolean close = request.headers().contains(CONNECTION) && HttpHeaders.Values.KEEP_ALIVE.equals(request.headers().contains(CONNECTION));
	...
	private void writeMenu(ChannelHandlerContext ctx) {
		...
		responseContent.append("<title>Netty TestClient Form</title>\r\n");
		responseContent.append("</head>\r\n");
		responseContent
		...
		responseContent.append("<h1>Netty TestClient Form</h1>");
